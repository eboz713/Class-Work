...
public class BoundedQueue {
    ...
    /**
     * Constructor of BoundedQueue class
     * @param capacity an integer number indicating the capacity of queue
     * @throws IllegalStateException if capacity is negative value
     */
     ...
     * @throws NullPointerException If argument o is null
    ...
    /**
     * @return oldest element of the queue -- Last In First Out (LIFO)
   ...
   /**
    * @return true if the queue reaches its maximum capacity
    */
   ...
   /**
    * @return a string representation of the object elements.
    */
